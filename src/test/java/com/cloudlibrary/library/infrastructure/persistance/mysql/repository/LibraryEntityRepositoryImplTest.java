...
class LibraryEntityRepositoryImplTest {
    ...
    @Test
    @Transactional
    public void findLibraryAllTest() throws Exception
    {
        //given
        Library library1 = Library.builder()
                .name("test 도서관")
        ...
        List<Library> libraryAll = libraryEntityRepository.findLibraryAll();
        //then
        assertThat(libraryAll.get(0).toString()).isEqualTo(libraryResult1.get().toString());
        assertThat(libraryAll.get(1).toString()).isEqualTo(libraryResult2.get().toString());
    }
}